...
/** Compact, media-first player tile with optional jersey chip and meta */
export default function PlayerCard({ p }: { p: Player }) {
  // Normalize jersey number (digits only)
    ...
    >
      ...
      <div className="relative aspect-[4/3] bg-white/5">
        {p.strThumb ? (
          <>
            ...
            {/* Decorative overlays */}
            <div
              className="absolute inset-0 bg-gradient-to-t from-[rgba(9,16,26,0.85)] via-transparent to-transparent"
              aria-hidden="true"
            />
            <div
      ...
      <div className="p-3 sm:p-3.5">
        <div className="flex items-start justify-between gap-2 sm:gap-3">
          ...
          {/* Compact meta chip (hidden on very tight widths) */}
